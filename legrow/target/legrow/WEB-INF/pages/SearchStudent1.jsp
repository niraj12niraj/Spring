				...
				<div class="grid_3"
					...
					<legend
						...
						<img src="${images}/signup.png"
							...
							style="padding: 5px 0 5px 0;">&nbsp;Student Information</i>
					</legend>
					 ...
					 <form style="margin: 5%;" action="${pageContext.request.contextPath}/admin/getStudentByID/{id}"  enctype="multipart/form-data" method='POST'>
					...
					<!-- </div> -->
							...
							<tr>
							  ...
							  <td>Enrollment No.</td>
								<td><input type=text name="id" id="id" value="${stu.id}"
							...
							<td>Batch</td>
								<td><input type="text" name="batch" size="30"  value="${stu.batch}">
								</td>
									
									<td>Time</td>
								<td><input name="time"  size="30"  value="${stu.time}" >
							...
							<tr>
								<td>Course</td>
								<td><input type="text" name="cource" size="30"  value="${stu.cource}" >
								</td>
