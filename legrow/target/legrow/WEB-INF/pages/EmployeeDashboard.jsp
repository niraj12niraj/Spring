...
<body>
	...
	<nav>
		<div class="container-fluid" style="background-color: #3db4db;">
			<ul class="nav nav-pills">
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					data-toggle="dropdown" style="color: black;">EMPLOYEE <b
						class="caret"></b></a>
					<ul class="dropdown-menu" style="">
						<li><a href="${pageContext.request.contextPath}/employee/SearchEmployeeAttdence">EMPLOYEE SCHEDULE</a></li>
			...
			<li><a href="${pageContext.request.contextPath}/employee/changeEmployeePass" class="drop-down" style="color: black;">CHANGE PASSWORD </a></li>
