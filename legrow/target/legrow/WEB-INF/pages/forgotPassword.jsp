...
<div class="col-sm-2"></div>
		...
		<c:if test="${msg != null}">
		<h4>${msg}</h4></c:if>
					<form action="${pageContext.request.contextPath}/emailSend"
						style="background-color:#d3d8df; box-shadow: 0px 0px 5px #800000; margin-bottom: 30px"
						method="post">
						<h3  class="text-center" style=" background-color:maroon;height:40px;color:white;padding-top: 5px">Forgot Password</h3>
						<table class="table">
							...
							<tr>
								...
								<td><input type="submit" style="width: 200px"
									class="btn btn-info btn-xl center-block" value="Submit" /></td>
							</tr>
						</table>
