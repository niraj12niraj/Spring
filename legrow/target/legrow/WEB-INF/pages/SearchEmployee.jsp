				...
				<div class="grid_3"
					...
					<legend
						...
						<img src="${images}/signup.png"
							...
							style="padding: 5px 0 5px 0;">&nbsp;Search Employee</i>
					</legend>


 <form action="${pageContext.request.contextPath}/admin/getEmployeeByID">
  <table>
  <div class="form-group">
    <label for="email">Employee ID:</label>
    <input type="text" class="form-control" name="abhishek">
  </div>
  </table>
