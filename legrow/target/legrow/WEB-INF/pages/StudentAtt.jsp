		...
		<div class="row">
			...
			<div class="col-md-4" style="padding: 20px;">
				<div class="grid_1"
					...
					<legend
						style="width: 100%; height: 15%; border-top-left-radius: 10px; border-top-right-radius: 10px; background-color: #F69876; background: -webkit-gradient(linear, left top, left bottom, color-stop(0, rgba(255, 255, 255, .2)), color-stop(100%, rgba(0, 0, 0, .2))) #09c; background: -webkit-linear-gradient(top, rgba(255, 255, 255, .2) 0, rgba(0, 0, 0, .2) 100%) #09c; background: -o-linear-gradient(top, rgba(255, 255, 255, .2) 0, rgba(0, 0, 0, .2) 100%) #09c; background: -ms-linear-gradient(top, rgba(255, 255, 255, .2) 0, rgba(0, 0, 0, .2) 100%) #09c; background: linear-gradient(top, rgba(255, 255, 255, .2) 0, rgba(0, 0, 0, .2) 100%) #09c; color: #000000; color: #000000; font-size: 180%; padding: 0 0 0 28%;">
						<img src="${images}/done.png" style="width:25px;height:35px;">
						<i style="padding: 5px 0 5px 0;">&nbsp;Attendence
						</i>
					</legend>
					...
					<form style="margin:5%;" name='loginForm'
						...
						<table style="width: 100%;">
							...
							<tr>
								<td>USER ID</td>
								<td><input type="userid" name="userid" id="userid" size="20"placeholder="Enter Id"></td>
							</tr>
							<tr>
							...
							<tr>
								<td>DATE</td>
								<td>  <input type="date" name="pickup_date" placeholder="Date"></td>
							</tr>
