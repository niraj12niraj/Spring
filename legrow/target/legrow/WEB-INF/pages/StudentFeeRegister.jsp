				...
				<div class="grid_3"
					...
					<legend
						...
						<img src="${images}/signup.png"
							...
							style="padding: 5px 0 5px 0;">&nbsp; Student Fee Detail</i>
					</legend>					
					
					 <form style="margin: 5%;" action="${pageContext.request.contextPath}/admin/saveStudent_FeeDetail"  enctype="multipart/form-data" method='POST'>
						<table style="width: 100%;">
							<tr>						
						
								 <td>Enrollment No.</td>
								<td><input type=text name="id" id="enrollmentno"
								...
								<tr>
								<td>Tution Fee </td>
								<td><input type="text" name="tutionfee"
									placeholder="Enter Tution Fee" size="30"></td>
							

								<td>Hostel Fee</td>
								<td><input type="text" name="hostelfee"
									size="30" placeholder="Enter HOSTEL FEE"></td>

							</tr>
								
								<tr>
								<td>Examination Fee</td>
								<td><input type="text" name="examinationfee"
									placeholder="Enter Examination Fee" size="30"></td>
													
							<td>Current Address</td>
								<td><input type="text" name="registrationfee"
									placeholder="Enter Registraion Fee" size="30"></td>
							</tr>
							...
							<tr>
								<td colspan="1">
								<td><input type="reset" class="btn"> <input type="submit" class="btn"
									value="Save" /></td>
							</tr>
						</table>
