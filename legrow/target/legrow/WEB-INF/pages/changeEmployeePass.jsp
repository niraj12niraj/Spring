...
<script type="text/javascript">
	function vlidationOfPassword() {
		if (frm01.pass.value == "") {
			alert("Enter the Password.");
			frm.pass.focus();
			return false;
		}
		if (frm01.newPass.value == "") {
			alert("Enter the new Password.");
			frm.pass.focus();
			return false;
		}
		if (frm01.conPass.value == "") {
			alert("Enter the cofirm new Password.");
			frm.pass.focus();
			return false;
		}
		if ((frm01.pass.value).length < 4) {
			alert("Password should be minimum 4 characters.");
			frm.pass.focus();
			return false;
		}
		if ((frm01.newPass.value).length < 4) {
			alert("Password should be minimum 4 characters.");
			frm.pass.focus();
			return false;
		}
		if ((frm01.conPass.value).length < 4) {
			alert("Password should be minimum 4 characters.");
			frm.pass.focus();
			return false;
		}
		if (frm01.newPass.value != frm01.conPass.value) {
			alert("Password and confermation password does not match.");
			return false;
		}
		return true;
...
<body style="background-color: #FFFFFF">
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-9" style="background-color:#F8F2F2;margin-bottom:30px;box-shadow: 0px 0px 10px grey">
				<form name="frm01" action="${pageContext.request.contextPath}/employee/changePass3" method="post">
				<h3 style="color:green">${change}</h3>
				<h3 style="color:red">${nochange}</h3>
					<div style="padding-right: 20px; padding-left: 20px;">

						<div>
							<h2 style="color: #428bca">Change Your Password</h2>
						</div>

						<div class="form-group" ; style="padding-top: 10px;">
							<label for="pass" class="control-label">Current Password</label>
							<div>
						...
						<div class="form-group" ; style="padding-top: 10px;">
							<label for="conPass" class="control-label">Confirm New
								Password</label>
							<div>
								<input type="text" class="form-control" name="conPass"
									placeholder="Conferm Your New Password"  required>
							</div>
						</div>
					</div>
					<center><input type="submit" name="submit" value="Submit" class="btn btn-primary btn-xl btn-block" style="height: 50px;width:200px " onclick="return vlidationOfPassword();" /> 
					</center>
