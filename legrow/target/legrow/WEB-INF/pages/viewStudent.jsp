				...
				<div class="grid_3"
					...
					<legend
						...
						<img src="${images}/signup.png"
							...
							style="padding: 5px 0 5px 0;">&nbsp;Student Info</i>
					</legend>
					 ...
					 <form style="margin: 5%;" action="${pageContext.request.contextPath}/admin/viewUpdateStudent"  enctype="multipart/form-data" method='POST'>
						...
						<tr><td>
						<div class="col-sm-5">
					<div class="Image_b"><center><img alt="Student photo"
						src="${pageContext.request.contextPath}/admin/downloadPhoto/${stu.id}"
						style="height: 150px; width: 150px" /></center></div>
					</div>
							...
							<td>Course</td>
								<td><input name="cource" value="cource" value="${stu.cource}" >
										</td>
							</tr>

							<tr>
								<td>Batch</td>
								<td><input name="batch" value="batch" value="${stu.batch}">
										
								</td>
							
									<td>Time</td>
								<td><input name="time" value="time" value="${stu.time}" >
										</td>
