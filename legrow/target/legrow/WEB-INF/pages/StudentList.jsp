...
$(document).ready(function(){
	...
	<div class="container-fluid" style="background-color: #3db4db;">
		<ul class="nav nav-pills">
			...
			<li><a href="#" class="drop-down" style="color: black;">STUDENT</a>
			</li>
				...
				<div class="grid_3"
					...
					<legend
						...
						<img
							...
							style="width: 45px; height: 35px;"> <i>STUDENT LIST</i>
					...
					<form style="margin: 5%;" name='schedule'
						...
						<table id="myTable" class="table table-striped table-bordered"
							...
							<tr>
							<td>${st.id}</td>
							<td><img alt="Student photo"
						src="${pageContext.request.contextPath}/admin/downloadPhoto/${st.id}"
						style="height: 80px; width: 80px" /></td>	
							<td>${st.name}</td>
							<td>${st.fatherName}</td>
							<td>${st.email}</td>	
							<td>${st.mobile}</td>
							 <td><a href="${pageContext.request.contextPath}/admin/updateStudent?id=${st.id}" class="btn">Update</a></td> 		
							  <td><a href="${pageContext.request.contextPath}/admin/deleteStudentByID/${st.id}" class="btn">Delete</a></td>
							   <td><a href="${pageContext.request.contextPath}/admin/viewStudent?id=${st.id}" class="btn">View</a></td> 
							</tr>
							</c:forEach>
							</tbody>
