				...
				<div class="grid_3"
					...
					<legend
						...
						<img src="${images}/signup.png"
							...
							style="padding: 5px 0 5px 0;">&nbsp;Employee Info</i>
					</legend>
					 ...
					 <form style="margin: 5%;" action="${pageContext.request.contextPath}/admin/viewEmployee"  enctype="multipart/form-data" method='POST'>
						...
						style="height: 150px; width: 150px" /></center>
							...
							<tr>
								...
								<td><input  name="password" type="text" value="${emp.password}"
									size="30" placeholder="Enter Password"></td></tr>
						<!-- 	</tr>
							<tr> <td>
