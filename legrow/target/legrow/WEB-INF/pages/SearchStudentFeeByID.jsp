...
<body>
	...
	<header class="container-fluid" style="background: #2d343E">
			...
			<div class="row">
				...
				<div class="col-sm-4">
					<div
						...
						<p>
							<a href="#" style="color: white;" class="btn btn-danger"><i
			...
			<div class="col-md-10" style="padding: 20px;">
				<div class="grid_3"
					...
					<legend
						...
						<img src="${images}/signup.png" style="width: 45px; height: 35px;"><i
							style="padding: 5px 0 5px 0;">&nbsp;Search Attedence By ID </i>
					</legend>

                
					<form
						action="${pageContext.request.contextPath}/student/getStudentFeeByID">
						<div class="form-group">
							<label for="email">Student Roll No:</label> <input type="text"
								class="form-control" name="abhishek">
						</div>
		...
		<div class="row" style="background-color: #d3d8df;">
			...
			<div class="col-sm-4" id="quick-links">
				...
				<ul>
					...
					<li style="padding: 3px 0 3px 0;"><a href="#">A.D.C.F.A</a></li>
