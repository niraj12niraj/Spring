...
<style="background-color: #FFFFFF">
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-10" style="background-color:#F8F2F2;margin-bottom:30px;box-shadow: 0px 0px 10px grey">
				<form name="frm01" action="${pageContext.request.contextPath}/admin/changePass0" method="post">
