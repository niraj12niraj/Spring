...
<body>
					...
					<div class="col-sm-4">
						<div
							...
							<p>
								...
								<a href="#" class="btn btn-primary" style="color: #ffffff;"><i
									class="fa fa-unlock-alt"></i>&nbsp;&nbsp;Login</a> <a href="#"
	...
	<nav>
		<div class="container-fluid" style="background-color: #3db4db;">
			<ul class="nav nav-pills">
				<li><a href="/VITWorld/index"> <i class="icon-home icon-2x"></i>
				</a></li>
				...
				<li><a href="/VITWorld/admin" class="drop-down"
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					data-toggle="dropdown" style="color: black;">STUDENT <b
						class="caret"></b></a>
					<ul class="dropdown-menu" style="">
						<li><a href="${pageContext.request.contextPath}/student/SearchStudentAttdence">ATTENDENCE</a></li>
						<li><a href="${pageContext.request.contextPath}/student/SearchStudentFeeByID">FEE DETAILS</a></li>
					</ul></li>


					

			<li><a href="${pageContext.request.contextPath}/student/changestudentPass" class="drop-down" style="color: black;">CHANGE PASSWORD </a></li>
			<li><a href="${pageContext.request.contextPath}/logout" style="color: black;">LOGOUT </a></li>
	...
	<!-- Student DashBoard started here -->
			...
			<div class="col-md-8" style="padding: 20px;">
				<div class="grid_1"
					...
					<legend
						...
						<i style="padding: 5px 0 5px 0;">&nbsp;User Info </i>
					</legend>
								...
								<div class="col-sm-4">
									<tr>
										<div class="btn-group-vertical" style="margin: 20px;">
											<button type="button" class="btn btn-success">Personal
												Details</button>
											<button type="button" class="btn btn-primary">Records</button>
											<button type="button" class="btn btn-info">Fee
												details</button>
											<button type="button" class="btn btn-warning">Contact
												information</button>
										</div>
									</tr>
								</div>
					...
					<div class="col-sm-4" id="brand-footer">
						<p>
							<img src="${images}/logo.png"
								alt="Tech Altum Logo" style="color: blue; margin-left: 80px;">
						</p>
						...
						<p>
							<a class="two" href="" target="_blank"
								style="margin-left: 107px;">Follow on Twitter</a>
						</p>


						<p>
							<a class="two" href="" target="_blank"
								style="margin-left: 100px;">Follow on Facebook</a>
						</p>
			...
			<div class="row"
				...
				<div class="navbar-header col-lg-2">
					<a class="navbar-brand"
						...
						src="${images}/unnamed.png" width="30"
						height="30" alt="Supersoft IT Solutions Noida" />
					</a>
				</div>
			</div>
		</section>
