...
<!-- <script type="text/javascript"
	src="resources/sliderman/sliderman.1.3.8.js"></script>
<link rel="stylesheet"
			...
			<div class="row">
				<div class="col-md-2">
					<div class="_sidebar white_box" style="">
						...
						<div>
							<a
								href="${pageContext.request.contextPath}/updateCustmerAndUserProfile?name=updateProfile">Update
								Profile </a>
						</div>
						<div>
							<a
								href="${pageContext.request.contextPath}/customer/changeCustmerAndUserPassword?name=updatePassword">Update
								Password </a>
						</div>
