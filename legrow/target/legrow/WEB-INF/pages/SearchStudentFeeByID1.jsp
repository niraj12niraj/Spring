			...
			<div class="col-md-10" style="padding: 20px;">
				<div class="grid_3"
					...
					<legend
					 ...
					 <form style="margin: 5%;" action="${pageContext.request.contextPath}/student/getStudent_FeeDetailById/{id}"  enctype="multipart/form-data" method='POST'>
						
						<div class="col-sm-5">
					<div class="Image_b"><img alt="Student photo"
						...
						<table style="width: 100%;">
							<tr>
							  ...
							  <td>Enrollment No.</td>
								<td><input type="text" name="no"  value="${stufee.id}"
									size="30" ></td>  									
									
								<td>Name</td>
								<td><input type="text" name="name" value="${stufee.name}" size="30" 
									placeholder="Name"></td>
							...
							<td>TUTION_FEE</td>
								<td><input type="text" name="tutionfee" size="30"  value="${stufee.tutionfee}">
								</td>
									
									<td>HOSTEL_FEE</td>
								<td><input name="hostelfee"  size="30"  value="${stufee.hostelfee}" >
															
								</td>
							</tr>

							<tr>
								<td>EXAMINATION_FEE</td>
								<td><input type="text" name="examinationfee" size="30"  value="${stufee.examinationfee}" >
								</td>
									
								<td>REGISTRATION_FEE</td>
								<td><input  name="registrationfee" type="dob"     value="${stufee.registrationfee}"
									placeholder="registrationfee" size="30"></td>
