				...
				<div class="grid_3"
					...
					<legend
						...
						<img src="${images}/signup.png"
							...
							style="padding: 5px 0 5px 0;">&nbsp;Add Student FeeDetail</i>
					</legend>
					 ...
					 <form style="margin: 5%;" action="${pageContext.request.contextPath}/admin/saveStudent_FeeDetail"  enctype="multipart/form-data" method='POST'>
						<table style="width: 100%;">
							...
							<tr>
								<td>TUTION FEE</td>
								<td><input type="tutionfee" name="tutionfee"
									placeholder="tutionfee" size="30"></td>
							...
							<td>Registration Fee</td>
								<td><input type="text" name="registrationfee"
									placeholder="Enter Registration Fee" size="30"></td>
							</tr>
