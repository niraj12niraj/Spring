				...
				<div class="grid_3"
					...
					<legend
						...
						<img src="${images}/signup.png"
							...
							style="padding: 5px 0 5px 0;">&nbsp;Add Student</i>
					</legend>
					 ...
					 <form style="margin: 5%;" action="${pageContext.request.contextPath}/admin/saveStudent"  enctype="multipart/form-data" method='POST'>
					...
					<center>	
					<img alt="Image"
						src="${pageContext.request.contextPath}/admin/downloadPhoto/${stu.id}"onload="loadImage()"
						style="height: 150px; width: 150px" /></center>
							...
							<tr>						
								...
								<%-- <td>Enrollment No.</td>
								<td><input type=text name="enrollmentno" id="enrollmentno"
								...
								<td>Course</td>
								<td><select name="cource" value="cource" >
								...
								<tr>
								<td>Batch</td>
								<td><select name="batch" value="batch" >
										<option value="-1" selected>select..</option>
									...
									<td>Time</td>
								<td><select name="time" value="time" >
										<option value="-1" selected>select..</option>
							...
							<tr>								
								<td>City</td>
								<td><input type="text" name="city" id="emailid"
							...
							<tr> <td>
							 Photo:-<input type="file" name="fileUpload"id="img1"></input><br>  
							</td></tr>
