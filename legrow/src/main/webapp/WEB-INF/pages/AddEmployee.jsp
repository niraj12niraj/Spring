				...
				<div class="grid_3"
					...
					<legend
						...
						<img src="${images}/signup.png"
							...
							style="padding: 5px 0 5px 0;">&nbsp;Add Employee</i>
					</legend>
					 ...
					 <form style="margin: 5%;" action="${pageContext.request.contextPath}/admin/saveEmpRegistration"  enctype="multipart/form-data" method='POST'>
						<%-- <div class="row"><div class="col-sm-5"><div class="Image_b">
						...
						style="height: 200px; width: 200px" />
							...
							<tr>
								...
								<td><input type="text" name="salary" id="salary"
									size="30" placeholder="Enter Salary">
							</tr>
							...
							<tr>
								...
								<td><input type="text" name="city" id="emailid"
									size="30" placeholder="Select City">
							</tr>
							...
							<tr>
								...
								<td><input type="text" name="state" id="state"
									size="30" placeholder="Select State">
							</tr>
							<tr><td>ROLE</td>
