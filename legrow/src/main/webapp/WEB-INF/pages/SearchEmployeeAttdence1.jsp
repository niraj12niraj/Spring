				...
				<div class="grid_3"
					...
					<legend
						...
						<img src="${images}/signup.png"
							...
							style="padding: 5px 0 5px 0;">&nbsp;Employee Attedence Information</i>
					</legend>
					
					
					 <form style="margin: 5%;" action="${pageContext.request.contextPath}/employee/getExcelById/{no}"  enctype="multipart/form-data" method='POST'>
						<table style="width: 100%;">
						
						<tr><td>
						<div class="col-sm-5">
					<div class="Image_b"><img alt="Upload Image"
						src="${pageContext.request.contextPath}/admin/downloadEmpPhoto/${emp.id}"
