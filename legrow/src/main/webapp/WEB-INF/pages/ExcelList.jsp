				...
				<div class="grid_3"
					...
					<legend
						...
						<img
							...
							style="width: 45px; height: 35px;"> <i>EXCEL LIST</i>
						...
						<table id="myTable" class="table table-striped table-bordered"
							...
							<thead>
								<tr><!-- 
									...
									<td style="color:red">LengthOWR</td>
									<td style="color:red">LengthOWA</td>
									<td style="color:red">LateT</td>
									<td style="color:red">LateMin</td>
									<td style="color:red">EarlyLT</td>
									<td style="color:red">EarlyLmin</td>
									<td style="color:red">OverTR</td>
									<td style="color:red">OverTS</td>
									</tr></thead>
									<tbody>
							<c:forEach items="${excel}" var="e">
							<tr>
							<td>${e.no}</td>	
							<td>${e.name}</td>
							<td>${e.department}</td>
							...
							<td>${e.ots}</td>	
									...
									<td style="color:red">BT</td>
									<td style="color:red">AB</td>
									<td style="color:red">L</td>
									<td style="color:red">BonusPR</td>
									<td style="color:red">BonusPO</td>
									<td style="color:red">BouncePA</td>
									<td style="color:red">PayDL</td>
									<td style="color:red">PayDD</td>
									<td style="color:red">ActualP</td>
									<td style="color:red">Memo</td> 
