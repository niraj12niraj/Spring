...
<!-- jQuery library -->
<script
	src="resources/javascript/jquery.min.js"></script>
<!-- Latest compiled JavaScript -->
<script
	src="resources/javascript/bootstrap.min.js"></script>

<script
	src="resources/javascript/jquery.easing.min.js"></script>

<script
	src="resources/javascript/angular.min.js"></script>
<script src="resources/javascript/wow.js"></script>
<script
	src="resources/javascript/demo.js"></script>
<script>
	new WOW().init();
</script>
<script async
	src="resources/javascript/functions.js"></script>

<script
	src="resources/javascript/megamenu.js"></script>
...
/* .banner {
  ...
  background: url("${pageContext.request.contextPath}/admin/downloadPhoto1/${stu.id}");
  width: 150px; /* Width of new image */
 /*  height: 150 *//* px; */ /* Height of new image */
...
<script>
function myFunction() {
    document.getElementById("myImg").src ="${pageContext.request.contextPath}/admin/downloadPhoto/${stu.id}";
}
</script>
				...
				<div class="grid_3"
					...
					<legend
						...
						<img src="${images}/signup.png"
							...
							style="padding: 5px 0 5px 0;">&nbsp;Update Student Information</i>
					</legend>
					 ...
					 <form style="margin: 5%;" action="${pageContext.request.contextPath}/admin/saveUpdateStudent"  enctype="multipart/form-data" method='POST'>
						...
						<tr><td>
						<div class="col-sm-5"><button onclick="myFunction()">
					<div class="Image_b"><div class="banner"><center><img alt="Student photo"
						src="${pageContext.request.contextPath}/admin/downloadPhoto1/${stu1.id}"
						style="height: 150px; width: 150px"id="myImg" /></center></div></div></button>
					</div>
							...
							<tr>
							  ...
							  <td>Enrollment No.</td>
								<td><input type=text name="id" id="enrollmentno" value="${stu.id}"
									size="30" placeholder="Enter Enrollment.No."></td>  
							...
							<tr>	
								...
								<td>Name</td>
								<td><input type="text" name="name" value="${stu.name}" size="30" 
									placeholder="Enter Name"></td>

							<td>Course</td>
								<td><select name="cource" value="cource" value="${stu.cource}" >
							...
							<tr>
								<td>Batch</td>
								<td><select name="batch" value="batch" value="${stu.batch}">
										<option value="-1" selected>select..</option>
										<option value="Morning">Morning Shift</option>
										<option value="Nonn">Afternoon Shift</option>
									...
									<td>Time</td>
								<td><select name="time" value="time" value="${stu.time}" >
										<option value="-1" selected>select..</option>
										<option value="09:00-11:00">09:00-11:00</option>
										<option value="12:00-14:00">12:00-14:00</option>
										<option value="15:00-17:00">15:00-17:00</option></td>
								...
								<td>Password</td>
								<td><input  name="password" type="text" value="${stu.password}"
							...
							<tr>
								...
								<td>DOB</td>
								<td><input  name="dob" type="dob" value="${stu.dob}"
									placeholder="Dob" size="30"></td>
							

								<td>Father's Name</td>
								<td><input name="fatherName" type="text" value="${stu.fatherName}"
								...
								<td><input type="text" name="paddress" value="${stu.paddress}"
									placeholder="Enter Permanent Address" size="30"></td>
													
							<td>Current Address</td>
								<td><input type="text" name="caddress" value="${stu.caddress}"
									placeholder="Enter current address" size="30"></td>
							</tr>
							
							<tr>
								<td>Mobile No.</td>
								<td><input type="text" name="mobile" value="${stu.mobile}"
									placeholder="Enter Mobile No." size="30"></td>

								<td>Email Id</td>
								<td><input type="text" name="email" id="emailid" value="${stu.email}"
									size="30" placeholder="Enter Email Id">
							</tr>
							
							<tr>
								<td>Gender</td>
								<td><input type="text" name="gender" value="${stu.gender}"
									placeholder="Enter Gender" size="30"></td>

								<td>Course</td>
								<td><input type="text" name="cource" value="${stu.cource}" 
									placeholder="Ente Course" size="30"></td>
								
						 </tr>
							
							<tr>								
								<td>City</td>
								<td><input type="text" name="city" value="${stu.city}"
									size="30" placeholder="Select City"></td>
									
									<td>District</td>
								<td><input type="text" name="district" value="${stu.district}"
							...
							<tr>
								...
								<td>State</td>
								<td><input type="text" name="state" id="state" value="${stu.state}"
									size="30" placeholder="Select State"> </td>
					
								<td>Pincode</td>
								<td><input type="text" name="pincode" id="pincode" value="${stu.pincode}"
									size="30" placeholder="Select State"> </td>				
									
							</tr>
							<tr> <td>
							 Photo:-<input type="file"></input><br>  
							</td></tr>
