			...
			<div class="col-md-10" style="padding: 20px;">
				<div class="grid_3"
					...
					<legend
					 ...
					 <form style="margin: 5%;" action="${pageContext.request.contextPath}/admin/getExcelById/{no}"  enctype="multipart/form-data" method='POST'>
						
						<div class="col-sm-5">
					<div class="Image_b"><img alt="Upload Image"
						src="${pageContext.request.contextPath}/admin/downloadPhoto/${stu.id}"
						...
						<table style="width: 100%;">
							<tr>
							  ...
							  <td>Enrollment No.</td>
								<td><input type="text" name="no"  value="${excel.no}"
									size="30" ></td>  									
									
								<td>Name</td>
								<td><input type="text" name="name" value="${excel.name}" size="30" 
									placeholder="Name"></td>
							...
							<td>Department</td>
								<td><input type="text" name="batch" size="30"  value="${excel.department}">
								</td>
									
									<td>Lowr</td>
								<td><input name="lowr"  size="30"  value="${excel.lowr}" >
							...
							<tr>
								<td>Lowa</td>
								<td><input type="text" name="lowa" size="30"  value="${excel.lowa}" >
								</td>
									
								<td>Late Time</td>
								<td><input  name="latet" type="dob"     value="${excel.latet}"
							...
							<%-- <tr>
								...
								<td><input name="fatherName" type="text" value="${stu.fatherName}"
									size="30" placeholder="Father Name"></td>
							...
							<tr>								
								...
								<td><input type="text" name="city" value="${stu.city}"
									size="30" placeholder="City"></td>
									
									<td>District</td>
								<td><input type="text" name="district" value="${stu.district}"
									placeholder="District" size="30"></td>
							</tr>
