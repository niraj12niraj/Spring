				...
				<div class="grid_3"
					...
					<legend
						...
						<img src="${images}/signup.png"
							...
							style="padding: 5px 0 5px 0;">&nbsp;Employee Information</i>
					</legend>
			
					
					
					 <form style="margin: 5%;" action="${pageContext.request.contextPath}/admin/getEmpRegistrationById/{id}"  enctype="multipart/form-data" method='POST'>
					...
					<div class="Image_b"><img alt="Upload Image"
						...
						style="height: 200px; width: 200px" /></div>
							...
							<tr>
								<td>Salary</td>
								<td><input  name="salary" type="text" value="${emp.salary}"
									size="30" placeholder="salary">
									</td>
							...
							<tr>
								...
								<td>Email Id</td>
								<td><input type="text" name="email" id="email" value="${emp.email}"
							...
							<td>Department</td>
								<td><input type="text" name="department" value="${emp.department}" 
									placeholder="department" size="30"></td> 
							...
							<tr>
								...
								<td><input type="text" name="pincode" id="pincode" value="${emp.pincode}"
									size="30" placeholder="pincode"> </td>				
								</tr>	
						<!-- 	</tr>
							<tr> <td>
